...
export default {
  ...
  head: {
    titleTemplate: titleChunk => {
      return titleChunk ? `${titleChunk} - ncolletti.com` : `ncolletti.com`
    },
    htmlAttrs: { lang: 'en' },
    meta: [
      { charset: 'utf-8' },
      ...
      { hid: 'profile:first_name', property: 'profile:first_name', content: 'Nick' },
      { hid: 'profile:last_name', property: 'profile:last_name', content: 'Colletti' },
      // Twitter
      { hid: 'twitter:card', name: 'twitter:card', content: 'summary' },
      { hid: 'twitter:site', name: 'twitter:site', content: '@ncolletti85' },
      { hid: 'twitter:creator', name: 'twitter:creator', content: '@ncolletti85' },
